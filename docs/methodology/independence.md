...
| Hypothetical bodies | Neely IDs 40–47, Harrington 50, Le Verrier 51, Adams 52, and Lowell 53 use page-level primary transcriptions; Transpluto/Isis 48, Pickering 54, Vulcan 55, Selena 56, Proserpina 57, and Waldemath 58 use the runtime models and project conventions documented in the methodology; only Nibiru 49 is recognised but unsupported | API shape and error behavior are checked ephemerally; the remaining source gap is listed in [the missing-models inventory](missing-hypothetical-models.md). |
