...
These are self-checking internal-consistency + defining-condition guards (no
external reference required). The independent-truth validation (NASA's Five
Millennium Canon contact times, the erfa/JPL shadow-geometry reference) lives
in the local validation sweeps.
"""
