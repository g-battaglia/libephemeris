...
Every predefined sidereal mode is anchored to the defining statement of its
author or of the primary scholarship, expressed as the pair
...
the same contract as ``SIDM_USER``. This script converts the published civil
dates and sexagesimal values into that pair form and writes the shared
definitions module. No input value derives from any external ephemeris
implementation; the derivation conventions are documented inline and in
