...
def _calc_pheno_leb(tjd_ut: float, ipl: int, iflag: int) -> Tuple[float, ...]:
    ...
    # ------------------------------------------------------------------
    if ipl == SE_MOON:
        # Moon: the Sun-Moon-Earth triangle is nearly degenerate (Sun ~1 AU
        # vs Moon ~0.003 AU), so law-of-cosines loses precision near syzygies.
        # Use the numerically stable identity instead.
