...
def _calc_pheno_leb(tjd_ut: float, ipl: int, iflag: int) -> Tuple[float, ...]:
    ...
    # ------------------------------------------------------------------
    if ipl == SE_MOON:
        # For the Moon the Sun-Moon-Earth triangle is extremely elongated
        # (Sun ~1 AU vs Moon ~0.003 AU).  The simple identity
        # phase_angle = 180 - elongation is standard and more stable than
        # the law-of-cosines form.
