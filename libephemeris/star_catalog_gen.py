...
Generated by scripts/build_star_catalog_v2.py on 2026-06-11 from public
sources only:
...
Provenance:
    AUTO-GENERATED by ``scripts/build_star_catalog_v2.py``. The field-level
    sources, source catalog identifiers, J1991.25-to-J2000 propagation, ICRS
    frame, units, join rules, name normalization, and duplicate handling are
    documented by that generator and above. This table contains no proprietary
    ephemeris star file and must never be hand-edited.
"""
