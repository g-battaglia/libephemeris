...
--------------------------------------------------
Inside 1850-2050 the ARMC matches the reference ephemeris to ~0.002". Outside
that window its black-box residual against this implementation has the shape of
a different long-term sidereal-time realization, so house cusps (ASC/MC)
diverge by a secular, sign-changing amount even at equal ΔT (ASC ≈ +1.5" at 2050, +0.9" at
...
the two. No claim about the reference's internal realization is required. NB:
the ~1.9" step seen near 2050 is present in black-box reference output (its
sidereal time has a one-time ~1.908" jump exactly at JD 2469807.5);
libephemeris's two branches join to 0.000000"
