...
class TestJulianDay:
    ...
    def test_julday_j2000(self):
        ...
        jd_py = ephem.julday(2000, 1, 1, 12.0)
    ...
    def test_julday_various_dates(self, test_dates):
        ...
        for year, month, day, hour, _ in test_dates:
            jd_py = ephem.julday(year, month, day, hour)
    ...
    def test_julday_boundaries(self):
        ...
        # End of month
        jd1 = ephem.julday(2000, 1, 31, 23.99)
        jd2 = ephem.julday(2000, 2, 1, 0.0)
        assert jd2 > jd1

        # End of year
        jd3 = ephem.julday(1999, 12, 31, 23.99)
        jd4 = ephem.julday(2000, 1, 1, 0.0)
        assert jd4 > jd3
...
class TestReverseJulianDay:
    ...
    def test_revjul_roundtrip(self, test_dates):
        ...
        for year_orig, month_orig, day_orig, hour_orig, _ in test_dates:
            ...
            jd = ephem.julday(year_orig, month_orig, day_orig, hour_orig)
            year, month, day, hour = ephem.revjul(jd)
...
class TestDeltaT:
    ...
    def test_deltat_exists(self):
        ...
        jd = 2451545.0
        dt_py = ephem.deltat(jd) * 86400  # Convert from days to seconds
...
class TestTimeConversions:
    ...
    def test_time_precision(self):
        ...
        jd2 = ephem.julday(2000, 1, 1, 12.0 + 1 / 3600)  # +1 second
